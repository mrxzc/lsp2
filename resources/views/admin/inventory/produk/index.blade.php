                            ...
                            <div class="card button-card">
                                <div class="card-body">
                                    ...
                                    <div class="button-icon">
                                        ...
                                        <a href="{{route('produk_tambah')}}" class="btn btn-rounded btn-warning"><span class="btn-icon-left text-warning"><i
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('produk_hapus', $produks->id)}}"><i class="fa fa-trash-o" aria-hidden="true" title="Hapus"></i></a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
