                            ...
                            <div class="card button-card">
                                <div class="card-body">
                                    ...
                                    <div class="button-icon">
                                        <a href="{{route('unit_tambah')}}" class="btn btn-rounded btn-info"><span class="btn-icon-left text-info"><i class="fa fa-plus color-info"></i> </span>Tambah Unit</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$units->id}}</td>
                                            <td>{{$units->unit}}</td>
                                            <td><a href="{{route('unit_hapus', $units->id)}}"><i class="fa fa-trash-o" aria-hidden="true" title="Hapus"></i></a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
