    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo"><a href="index.html"><b><img src="/gleek/gleek/assets/images/logo.png" alt=""> </b><span class="brand-title"><img src="/gleek/gleek/assets/images/logo-text.png" alt=""></span></a>
            </div>
                    ...
                    <ul>
                        ...
                        <li class="icons">
                            <a href="javascript:void(0)" class="log-user">
                                <img src="/gleek/gleek/assets/images/avatar/1.jpg" alt=""> <span>George Martin</span>  <i class="fa fa-caret-down f-s-14" aria-hidden="true"></i>
                            </a>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-md"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="nav-text">Master </span> <span class="badge badge-danger nav-badge">19</span></a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('kategori')}}">Kategori</a>
                            </li>
                            <li><a href="{{route('matauang')}}">Mata Uang</a>
                            </li>
                            <li><a href="{{route('unit')}}">Unit</a>
                            </li>
                            <li><a href="{{route('laba')}}">Persentase Laba</a>
                            </li>
                            <li><a href="{{route('stokppn')}}">Stok Minimal & PPN </a>
                            </li>
                        </ul>
                    </li>
                    <li class="mega-menu mega-menu-md"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="nav-text">Inventory </span> <span class="badge badge-danger nav-badge">19</span></a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('produk')}}">Produk</a>
                            </li>
                        </ul>
                    </li>
                    <li class="mega-menu mega-menu-md"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="nav-text">Laporan </span> <span class="badge badge-danger nav-badge">19</span></a>
                        <ul aria-expanded="false">
                            <li><a href="ui-alert.html">Laporan Barang Masuk</a>
                            </li>
                            <li><a href="ui-alert.html">Laporan Barang Keluar</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed by <a href="https://themeforest.net/user/digitalheaps">Digitalheaps</a>, Developed by <a href="https://themeforest.net/user/quixlab">Firman Kurniawan</a> 2018</p>
            </div>
        </div>
        <!--**********************************
            Footer end
