			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#fitur">
							...
							<div class="collapse" id="fitur">
								<ul class="nav nav-collapse">
                                    ...
                                    <li>
										<a href="{{route('laba')}}">
											<span class="sub-item">Persentase Laba</span>
										</a>
                                    </li>
                                    <li>
										<a href="{{route('stokppn')}}">
											<span class="sub-item">Stok Minimum & PPN</span>
										</a>
									</li>
					            </ul>
							</div>
